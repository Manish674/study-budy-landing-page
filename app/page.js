...
export default function Home() {
  ...
  return (
    <>
      <div></div>
      <div className="pb-4">
        <div className="border-b p-4 font-extrabold text-4xl">StudyBuddy</div>
        <div>
            ...
            <div className=" lg:w-[50%] mt-16 flex flex-col items-center justify-center">
              <div className="">
                ...
                <p className="p-4 text-[#635f68] text-center">
                  Welcome to StudyHub, virtual study platform designed to
                  enhance your academic journey. Connect with fellow students
                  through immersive video calls, collaborate seamlessly on
                  projects, and unlock your full potential with our suite of
